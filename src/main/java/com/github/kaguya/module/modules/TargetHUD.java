...
public class TargetHUD extends Module {
    ...
    public final ModeProperty posX = new ModeProperty("position-x", 1, new String[]{"LEFT", "MIDDLE", "RIGHT"}, () -> false);
    public final ModeProperty posY = new ModeProperty("position-y", 1, new String[]{"TOP", "MIDDLE", "BOTTOM"}, () -> false);
    ...
    public final BooleanProperty entity = new BooleanProperty("entity", true, () -> false);
    public final BooleanProperty outline = new BooleanProperty("outline", false, () -> false);
    public final BooleanProperty animations = new BooleanProperty("animations", true, () -> false);
    ...
    public void onRender(Render2DEvent event) {
        if (this.isEnabled() && mc.thePlayer != null) {
            ...
            if (this.target != null) {
                ...
                RenderUtil.drawRect(0.0F, barTop, barTotalWidth, barBottom, ColorUtil.darker(healthBarColor, 0.2F).getRGB());
                RenderUtil.drawRect(0.0F, barTop, healthRatio * barTotalWidth, barBottom, healthBarColor.getRGB());
